    ...
    <section className="text-gray-600 body-font" id='portfolio'>
      <div className="pb-20 mx-auto">
        ...
        <div className="container mx-auto px-5 flex flex-wrap items-center  overflow-x-auto overflow-y-hidden py-10 bg-white text-gray-800">
          <button className="flex items-center flex-shrink-0 px-5 py-2 space-x-2text-gray-600 bg-primary text-white rounded mr-3 font-semibold hover:opacity-90 transition active:scale-90">
            <span>All</span>
          </button>
          <button className="flex items-center flex-shrink-0 px-5 py-2 space-x-2text-gray-600 bg-gray-100 rounded mr-3 font-semibold hover:opacity-90 transition active:scale-90">
            <span>Front-end</span>
          </button>
          <button className="flex items-center flex-shrink-0 px-5 py-2 space-x-2text-gray-600 bg-gray-100 rounded mr-3 font-semibold hover:opacity-90 transition active:scale-90">
            <span>Back-end</span>
