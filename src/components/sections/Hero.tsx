                ...
                <div className="relative px-4 xl:px-0 container mx-auto md:flex items-center gap-8">
                    <div className="text-color w-full md:w-1/2 pt-16 lg:pt-32 xl:pt-12">
                        ...
                        <div className="lg:flex">
                            <Link href="https://drive.google.com/file/d/1m4jno2qeLwNLRmme4zWjZY_fvh-UdglO/view" target="_blank" className="flex justify-center hover:opacity-90 text-base w-full xl:text-base xl:w-6/12 mt-4 xl:mt-8 f-f-r p-4  bg-primary text-white font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary uppercase rounded">Download resume <ArrowDownTrayIcon className='h-5 w-5 ml-3' /></Link>
                            <Link href="#portfolio" className="flex justify-center hover:opacity-90 text-base w-full xl:text-base xl:w-4/12 lg:ml-2 xl:ml-2 mt-4 xl:mt-8 f-f-r p-4  bg-indigo-200 text-indigo-600 font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary uppercase rounded whitespace-nowrap">explore demo <BsFillEyeFill className='h-5 w-5 ml-3' /></Link>
                        </div>
                    </div>
