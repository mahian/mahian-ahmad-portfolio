            ...
            <footer className="container mx-auto px-5 md:px-6 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <Link href="https://flowbite.com/" className="flex items-center mb-4 sm:mb-0">
                        <span className="self-center text-2xl font-semibold whitespace-nowrap">Mahian ahmad</span>
                    </Link>
                ...
                <span className="block text-sm text-gray-500 sm:text-center">© <a href="https://flowbite.com/" className="hover:underline">Mahian Ahmad</a>. All Rights Reserved.
                </span>
            </footer>
        </div>
    );
